    ...
    if (currentMapMode === 'blur') {
        ...
        Object.entries(prefectureGroups).forEach(([prefecture, locations]) => {
            ...
            if (center) {
                ...
                // ポップアップを作成してバインド
                const popupContent = createBlurPopupContent(prefecture, locations);
                const popup = L.popup({
                    maxWidth: 300,
                    closeButton: true,
                    autoClose: true,  // 他のポップアップを開いたら自動で閉じる
                    closeOnClick: false,
        ...
        stoneLocations
            ...
            .forEach(location => {
                ...
                // ポップアップを作成してバインド
                const popupContent = createClearPopupContent(location);
                const popup = L.popup({
                    maxWidth: 300,
                    closeButton: true,
                    autoClose: true,  // 他のポップアップを開いたら自動で閉じる
